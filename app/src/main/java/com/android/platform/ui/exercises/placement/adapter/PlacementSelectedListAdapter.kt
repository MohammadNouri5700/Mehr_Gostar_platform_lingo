...
class PlacementSelectedListAdapter(val items: ArrayList<String>,var itemsA: AdapterTarget, val viewModel: PlacementViewModel, val ctx: Context) : RecyclerView.Adapter<PlacementSelectedListAdapter.TaskViewHolder>() {
