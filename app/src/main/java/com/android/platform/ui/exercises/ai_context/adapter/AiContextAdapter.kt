...
class AiContextAdapter(private var items: List<AiContextEntity>, val viewModel: AIContextViewModel, val isUs:Boolean, private val ctx: Context) : RecyclerView.Adapter<AiContextAdapter.TaskViewHolder>() {
